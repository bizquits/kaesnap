<div class="kiosk-screen kiosk-screen--with-header flex h-full w-full flex-col">
    ...
    'title' => 'SELECT FRAME',
    'subtitle' => 'Choose your stage',
    'primaryId' => 'btn-frame-next',
    'primaryLabel' => 'CONFIRM ▶',
    'primaryDisabled' => true,
    ])

    <div class="kiosk-screen-body flex-1 overflow-y-auto p-4">
        <div id="frame-grid"
            ...
            <button
                ...
                <span class="kiosk-frame-card__image-wrapper mb-2 flex w-full items-center justify-center overflow-hidden"
            ...
            <div class="col-span-full flex flex-col items-center justify-center py-20 text-center gap-4">
                ...
                <p style="font-family:'Press Start 2P',monospace;font-size:0.5rem;color:var(--text-dim);letter-spacing:0.08em;">
                    NO FRAMES FOUND
                </p>
            </div>
            @endforelse
