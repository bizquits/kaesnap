...
export function createStateMachine(handlers = {}, initial = "IDLE") {
    ...
    function setState(newState) {
        // Dari Welcome (IDLE) tidak boleh loncat langsung ke PAYMENT — harus lewat FRAME → REVIEW_ORDER.
        // (Halaman continue setelah bayar diload dengan initialState=CAPTURE sehingga state sudah CAPTURE.)
